  ...
  return (
    <div className="position-relative">
      ...
      <div className="position-relative mb-4">
        <div className="position-absolute top-5 start-50 translate-middle text-center w-100">
        ...
        <div className="banner-container">
          <div className="banner-content">
            <div className="banner-text">
              <h1 className="banner-heading">What We Offer</h1>
              <p className="banner-description">
                Looking for your dream job or the perfect candidate? Our
                platform connects job seekers and employers with ease. Post job
                listings or browse opportunities across industries. Whether
                you're hiring or searching, we make the process seamless and
                efficient. Start your journey to success today!
              </p>
            </div>
            <div className="banner-image">
              <img src={img} alt="Banner Illustration" />
            </div>
          </div>
        </div>
      </div>
